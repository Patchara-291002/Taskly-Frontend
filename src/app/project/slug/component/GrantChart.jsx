...
export default function GrantChart({ projects }) {

    const transformDataToDataTask = (projects) => {
        const dataTask = [];
      
        projects.board.forEach((column) => {
          column.tasks.forEach((task) => {
            dataTask.push({
              x: [task.creatAt, task.dueDate], 
              y: task.taskName,
            });
          });
        });
    ...
    const dataTask = transformDataToDataTask(projects);
